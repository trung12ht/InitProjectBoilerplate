...
import org.project4.server.repository.BlackTokenRepository;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	@Autowired
	private BlackTokenRepository blackTokenRespository;
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		try {
			...
			if (StringUtils.hasText(jwt) && blackTokenRespository.existsByToken(jwt)) {
...
//        blackTokenRespository.deleteByCreateBefore(new Date());
    }
